...
# else:
#     raise OSError # dataset_path = 'path_to_dataset' DESKTOP-769SV61

# if 'DESKTOP-769SV61' == hostname:
#     dataset_path = 'D:\datasets\SIDD_Medium_Srgb'
# else:
#     raise OSError # dataset_path = 'path_to_dataset' DESKTOP-769SV61
# dataset_path = 'D:\datasets'
# dataset_path = 'E:\\博士期间资料\\田亚军\\田博给的数据\\2021.6.07 新疆数据\\xinjiang\\prep\\SEGY_s256_o128'
dataset_path = '/home/shendi_mcj/datasets/seismic/fielddata/train/prep/SEGY_s256_o128'
# c, h, w numpy
